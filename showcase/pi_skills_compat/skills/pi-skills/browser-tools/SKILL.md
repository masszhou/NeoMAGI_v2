...
Does not require API credentials. Browser profile data and cookies are credentials for safety purposes.

## Sensitive operations

Require same-turn user confirmation before `browser-start.js --profile` or `browser-cookies.js`. Treat screenshots, DOM dumps, and JavaScript evaluation on authenticated pages as sensitive.
